...
test('See WO issuer group', async ({ woInstitutionAdminPage: woPage }) => {
  // var
  ...
  await expect(woPage.page).toHaveScreenshot('See existing issuer group.png', {
    mask: [dateMask, badgeclassMask],
  });
});
