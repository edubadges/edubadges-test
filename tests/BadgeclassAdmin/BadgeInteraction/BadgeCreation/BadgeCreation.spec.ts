...
institutions.forEach((institution) => {
  test.skip(`Validate error messages empty ${institution} microcredential form`, async ({
    adminPage,
  }) => {
    // var
  ...
  test.skip(`Validate error messages empty ${institution} regular badge form`, async ({
    adminPage,
  }) => {
    // var
    const issuers = adminPage.managePage.issuersPage;
  ...
  test.skip(`Validate error messages empty ${institution} extra curricular badge form`, async ({
    adminPage,
  }) => {
    // var
    const issuers = adminPage.managePage.issuersPage;
  ...
  test.skip(`Validate regular ${institution} edu badge creation`, async ({
    adminPage,
    testdata,
  }) => {
    // var
  ...
  test.skip(`Validate micro credential ${institution} edu badge creation`, async ({
    adminPage,
    testdata,
  }) => {
    // var
  ...
  test.skip(`Validate extra curricular ${institution} edu badge creation`, async ({
    adminPage,
    testdata,
  }) => {
    // var
