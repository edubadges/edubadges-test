...
institutions.forEach((institution) => {
  test.skip(`Edit existing Regular ${institution} edubadge`, async ({
    adminPage,
  }) => {
    // var
  ...
  test.skip(`Edit existing ${institution} micro credential`, async ({
    adminPage,
  }) => {
    // var
    const issuerGroupName = 'Medicine';
  ...
  test.skip(`Edit existing extra curricular ${institution} edubadge`, async ({
    adminPage,
  }) => {
    // var
    const issuerGroupName = 'Medicine';
